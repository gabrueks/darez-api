...
describe('PUT /v1/companies', () => {
  ...
  it('should update a company info', async () => {
    ...
    const response = await request(server).put('/v1/companies').set('Authorization', login.body.access_token).send({
  ...
  it('should update a company address', async () => {
    await request(server).post('/v1/users').send({
      phone_country_code: phoneCountryCode,
      phone_area_code: phoneAreaCode,
      phone_number: phoneNumber,
  ...
  it('should update a company business hour', async () => {
    await request(server).post('/v1/users').send({
      phone_country_code: phoneCountryCode,
      phone_area_code: phoneAreaCode,
      phone_number: phoneNumber,
  ...
  it('should return unauthorized when request without token', async () => {
    const response = await request(server).put('/v1/companies').send();
