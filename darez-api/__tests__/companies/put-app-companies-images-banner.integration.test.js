...
describe('PUT /v1/app/companies/images/banner', () => {
  let server;
  let connection;
  ...
  it('should update a company banner without resizing', async () => {
    ...
    const response = await request(server).put('/v1/app/companies/images/banner')
  ...
  it('should return status of bad request when missing argument', async () => {
    ...
    const response = await request(server).put('/v1/app/companies/images/banner').set('Authorization', login.body.access_token).send({
      invalid_field: true,
    });
  ...
  it('should return unauthorized when request without token', async () => {
    const response = await request(server).put('/v1/app/companies/images/banner').send();
