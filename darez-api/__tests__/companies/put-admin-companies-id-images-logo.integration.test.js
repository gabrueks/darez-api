...
describe('PUT /v1/admin/companies/:ID/images/logo', () => {
  let server;
  let connection;
  ...
  it('should update a company logo without resizing when admin', async () => {
    ...
    const response = await request(server).put('/v1/admin/companies/54321/images/logo')
  ...
  it('should update a company logo after resizing when admin user', async () => {
    const mockSave = Jimp.read.mockImplementation(() => ({
      bitmap: {
        height: 281,
        width: 281,
  ...
  it('should return unauthorized when request without token', async () => {
    const response = await request(server).put('/v1/admin/companies/54321/images/logo').send();
