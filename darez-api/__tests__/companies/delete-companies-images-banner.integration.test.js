...
describe('DELETE /v1/companies/images/banner', () => {
  let server;
  let connection;
  ...
  it('should return status 204 for a company that does not has banner', async () => {
    ...
    const response = await request(server).delete('/v1/companies/images/banner')
  ...
  it('should delete a banner from a company that has a banner', async () => {
    await request(server).post('/v1/users').send({
  ...
  it('should return unauthorized when request without token', async () => {
    const response = await request(server).delete('/v1/companies/images/banner').send();
