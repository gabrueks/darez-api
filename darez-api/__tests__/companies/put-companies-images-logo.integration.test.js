...
describe('PUT /v1/companies/images/logo', () => {
  let server;
  let connection;
  ...
  it('should update a company logo without resizing', async () => {
    ...
    const response = await request(server).put('/v1/companies/images/logo')
  ...
  it('should return unauthorized when request without token', async () => {
    const response = await request(server).put('/v1/companies/images/logo').send();
