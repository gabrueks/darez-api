...
describe('PUT /v1/admin/companies/:ID', () => {
  ...
  it('should update a company info when loged in as admin', async () => {
  ...
  it('should update a company address when loged in as admin', async () => {
    await request(server).post('/v1/users').send({
      phone_country_code: adminPhoneCountryCode,
      phone_area_code: adminPhoneAreaCode,
      phone_number: adminPhoneNumber,
  ...
  it('should update a company business hour when loged in as admin', async () => {
    await request(server).post('/v1/users').send({
      phone_country_code: adminPhoneCountryCode,
      phone_area_code: adminPhoneAreaCode,
      phone_number: adminPhoneNumber,
